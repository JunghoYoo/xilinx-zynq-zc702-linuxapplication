...
HD_PWD='D:/Developers_KIT/Zynq702/TFTLCD/AXI_TFT/axi_tft_0_example/axi_tft_0_example.runs/axi_tft_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_tft_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source axi_tft_0.tcl
