...
vlog -work work CLK12288_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax CLK12288_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.CLK12288_tb work.glbl
