...
xst -ifn xst.scr
move CLK12288_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK12288_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK12288_exdes.ucf CLK12288_exdes

echo 'Running map'
map -timing -pr b CLK12288_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm CLK12288_exdes -w routed.ncd routed.v
cd ..
