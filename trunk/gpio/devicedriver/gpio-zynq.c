...
/* GPIO INTERRUPT WAIT QUEUE */
DECLARE_WAIT_QUEUE_HEAD(gpio_queue);
...
static int zynq_gpio_get_value(struct gpio_chip *chip, unsigned int pin)
{
    ...
    // sleep until GPIO IRQ
	interruptible_sleep_on(&gpio_queue);
...
{
	printk(KERN_INFO "ZYNQ GPIO DRIVER\n");
